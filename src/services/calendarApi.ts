...
const getApiUrl = (endpoint: string, agendaType: AgendaType = 'banho') => {
  ...
  switch (endpoint) {
    case 'base':
      switch (agendaType) {
        case 'banho': return endpoints.agendaBanho || 'https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/agenda/banho';
        case 'vet': return endpoints.agendaVet || 'https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/agenda/vet';
      }
    case 'adicionar':
      switch (agendaType) {
        case 'banho': return endpoints.agendaAdicionarBanho || 'https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/agenda/adicionar/banho';
        case 'vet': return endpoints.agendaAdicionarVet || 'https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/agenda/adicionar/vet';
      }
    case 'alterar':
      switch (agendaType) {
        case 'banho': return endpoints.agendaAlterarBanho || 'https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/agenda/alterar/banho';
        case 'vet': return endpoints.agendaAlterarVet || 'https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/agenda/alterar/vet';
      }
    case 'excluir':
      switch (agendaType) {
        case 'banho': return endpoints.agendaExcluirBanho || 'https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/agenda/excluir/banho';
        case 'vet': return endpoints.agendaExcluirVet || 'https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/agenda/excluir/vet';
      }
    default:
      return endpoints.agendaBanho || 'https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/agenda/banho';
  }
};
