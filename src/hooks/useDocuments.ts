...
export const useDocuments = () => {
  ...
  const handleDeleteDocument = async (id: number, title: string) => {
    try {
      ...
      const response = await fetch('https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/excluir-arquivo-rag', {
        method: 'POST',
        headers: {
  ...
  const clearAllDocuments = async () => {
    try {
      ...
      const response = await fetch('https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/excluir-rag', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const uploadFileToWebhook = async (file: File, category: string) => {
    try {
      ...
      const response = await fetch('https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/envia_rag', {
        method: 'POST',
        body: formData,
      });
