        ...
        <div className="p-4">
          <Tabs defaultValue="info">
            <TabsList className="grid w-full grid-cols-2">
              ...
              <TabsTrigger value="pet">Agendamento</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="pet" className="mt-4 space-y-4">
              <Card className="p-4">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Nome do Agendamento</h3>
                <p>{selectedConversation?.petName || 'Não informado'}</p>
              </Card>
              
              <Card className="p-4">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Solução</h3>
                <p>{selectedConversation?.petType || 'Não informado'}</p>
              </Card>
              
              <Card className="p-4">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Local</h3>
