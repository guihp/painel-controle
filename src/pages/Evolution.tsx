...
const Evolution = () => {
  ...
  const checkConnectionStatus = async () => {
    try {
      ...
      const response = await fetch('https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/confirma', {
        method: 'POST',
        headers: {
  ...
  const updateQrCode = async () => {
    try {
      ...
      const response = await fetch('https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/atualizar-qr-code', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleCreateInstance = async () => {
    ...
    try {
      ...
      const response = await fetch('https://n8n-c4ggs0sskw0kww00gco4888o.padariaidealsabores.com/webhook/instanciaevolution', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      <header className="bg-petshop-blue dark:bg-gray-800 text-white shadow-md transition-colors duration-300">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold">IAFÉ TECNOLOGIA</h1>
          </div>
